...
export default definePluginEntry({
  id: "openharness-governance",
  name: "OpenHarness Governance",
  description: "Multi-level permissions, path rules, command deny, and lifecycle hooks",
  register(api) {
    api.registerTool({
      name: "oh_permissions",
      label: "Manage Permissions",
      description: "View or modify governance settings: permission mode, path rules, denied commands, tool allow/deny lists.",
