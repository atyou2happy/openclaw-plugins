...
export default definePluginEntry({
  id: "openharness-memory",
  name: "OpenHarness Memory",
  description: "Persistent cross-session memory with MEMORY.md index, project-specific storage, and heuristic search",
  register(api) {
    api.registerTool({
      name: "oh_memory_add",
      label: "Add Memory",
      description: "Add a memory entry to the project's persistent memory. Memories persist across sessions and are loaded into context automatically when relevant.",
    ...
    api.registerTool({
      name: "oh_memory_list",
      label: "List Memories",
      description: "List all memory entries for the current project, sorted by most recently modified.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      description: "Search for relevant memory entries by keyword. Returns matching memories with content snippets.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      label: "Remove Memory",
      description: "Remove a memory entry by title.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      description: "View the full MEMORY.md index file for the current project.",
      parameters: Type.Object({}),
