...
export default definePluginEntry({
  ...
  description: "On-demand markdown skill loading compatible with anthropics/skills format",
  register(api) {
    api.registerTool({
      name: "oh_skill_list",
      label: "List Skills",
      description: "List all available skills with their names and descriptions. Use to discover what domain expertise is available.",
    ...
    api.registerTool({
      name: "oh_skill_load",
      label: "Load Skill",
      description: "Load a specific skill by name. Returns the full skill content for injection into context. Use when you need detailed domain guidance.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      label: "Search Skills",
      description: "Search for skills by keyword. Returns matching skills with descriptions. Use when you're not sure which skill applies.",
      parameters: Type.Object({
