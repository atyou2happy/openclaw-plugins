...
export default definePluginEntry({
  id: "openharness-swarm",
  name: "OpenHarness Swarm",
  description: "Multi-agent coordination: subagent spawning, team registry, task delegation, background task lifecycle",
  register(api) {
    api.registerTool({
      name: "oh_swarm_spawn",
      label: "Spawn Subagent",
      description: "Spawn a subagent to execute a task independently. Supports local (subprocess), remote, or in-process teammate modes. Returns an agent ID for tracking and communication.",
    ...
    api.registerTool({
      name: "oh_swarm_status",
      label: "Agent Status",
      description: "Get detailed status of a specific subagent by ID, including result output.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      description: "List all spawned subagents with their status, mode, and results.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      label: "Create Team",
      description: "Create a team of agents for coordinated multi-agent work. Teams track member agents and inter-agent messages.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      label: "List Teams",
      description: "List all teams and their member agents.",
      parameters: Type.Object({}),
    ...
    api.registerTool({
      ...
      description: "Send a message to a team or agent. Messages are stored for inter-agent coordination and context sharing.",
      parameters: Type.Object({
    ...
    api.registerTool({
      ...
      label: "Delegate Task",
      description: "Delegate a complex task to a specialized agent type. Automatically selects the right agent mode and spawns a subagent with context.",
      parameters: Type.Object({
